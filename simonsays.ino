...
// First choose a game mode (choose a color)
...
int replay_light = 0;
int user_light = 0; 
// Game mode selection variable (99 is default)
int gamemode = 99;
...
bool check_backwards() {
	// Determine if user selected the correct buttons for backwards game mode
	bool check = true;
...
void classic(){
	// Classic Simon game mode
	// First play the light sequence
	run_sequence();
	// Then receive user inputs with basic sounds enabled
...
void silly(){
	//placeholder gamemode, plays random tones and lights
