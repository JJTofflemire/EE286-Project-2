...
void musical(){
  ...
  int ode_notes[] = {330, 330, 349, 392, 392, 349, 330, 294, 262, 262, 294, 330, 330, 294, 294, 
                          330, 330, 349, 392, 392, 349, 330, 294, 262, 262, 294, 330, 294, 262, 262};
  int ode_delays[] = {364, 364, 364, 364, 364, 364, 364, 364, 364, 364, 364, 364, 572, 156, 832,
                           364, 364, 364, 364, 364, 364, 364, 364, 364, 364, 364, 364, 572, 156, 832};
  // This switch statement chooses the randomly chosen melody
  switch(melody){
    case 0:
      // Minecraft
      if(start < 8){
